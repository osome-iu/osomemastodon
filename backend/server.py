...
import psycopg2
from route_functions import instance_data_api, status_search_api,account_search_api,hashtag_search_api
...
app.register_blueprint(hashtag_search_api.blueprint)

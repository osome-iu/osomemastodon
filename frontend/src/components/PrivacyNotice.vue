<template>
    <div class="container-fluid px-4">
        ...
        <p>For additional information outlining how Observatory on Social Media collects, uses, and safeguards personal information obtained specifically through our website
            (<a href="https://osome.iu.edu/tools/mastodon/">https://osome.iu.edu/tools/mastodon/</a>), please also review the information below.
        </p>
        ...
        <p>Except as described in the <a href="https://privacy.iu.edu/privacy/global.html">IU Privacy statement</a>, we will not share any information with any other entities or organizations for any reason.</p>
        ...
        <h4>Cookies</h4>
        <p>For more information on how we use cookies, please review the <a href="https://privacy.iu.edu/privacy/global.html">IU Privacy statement</a>.</p>

        <h4>Use of Third Party Services</h4>
        <p>Our website does not utilize web analytics services beyond what is noted in the <a href="https://privacy.iu.edu/privacy/global.html">IU Privacy statement</a>.</p>
        ...
        <h3>Links to non-university sites</h3>
